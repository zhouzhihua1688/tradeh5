...
var vm = new Vue({
  ...
  data: (_data = {
    ...
    minPercent: 1,
    maxPercent: 20
  }, _defineProperty(_data, "annualYield", 0.05), _defineProperty(_data, "provinceWithAverageIncome", {
    '北京': 7706.00,
    '天津': 5265.00,
    '河北': 4748.92,
    '山西': 4581.25,
    ...
    '宁夏': 5464.17,
    '新疆': 4740.00
  }), _defineProperty(_data, "retireAgeWithPensionMonth", {
    '40': 233,
    '41': 230,
    '42': 226,
    '43': 223,
    ...
    '69': 65,
    '70': 56
  }), _defineProperty(_data, "retireSpendingReplaceRate", {
    '18': 0.70,
    '19': 0.70,
    '20': 0.70,
    '21': 0.70,
    ...
    '69': 0.616,
    '70': 0.550
  }), _defineProperty(_data, "ageWithFundCombination0", {
    combination1: {
      fundName: ['锐意优选养老1号', '稳进优选养老1号', '安享优选养老1号'],
      fundDesc: ['锐意优选养老1号', '稳进优选养老1号', '安享优选养老1号'],
      urls: ['htffundxjb://action?type=oap&subType=pp&groupId=A0039', 'htffundxjb://action?type=oap&subType=pp&groupId=A0027', 'htffundxjb://action?type=oap&subType=pp&groupId=A0049']
    },
    //测试链接
    // combination1: {
    //     fundName: ['锐意优选养老1号', '稳进优选养老1号', '安享优选养老1号'],
    ...
    combination2: {
      ...
      urls: ['htffundxjb://action?type=oap&subType=pp&groupId=A0042', 'htffundxjb://action?type=oap&subType=pp&groupId=A0043', 'htffundxjb://action?type=oap&subType=pp&groupId=A0035']
    },
    combination3: {
      fundName: ['锐意优选养老3号', '稳进优选养老3号', '安享优选养老3号'],
      fundDesc: ['锐意优选养老3号', '稳进优选养老3号', '安享优选养老3号'],
      urls: ['htffundxjb://action?type=oap&subType=pp&groupId=A0045', 'htffundxjb://action?type=oap&subType=pp&groupId=A0047', 'htffundxjb://action?type=oap&subType=pp&groupId=A0036']
    },
    combination4: {
      fundName: ['锐意优选养老4号', '稳进优选养老4号', '安享优选养老4号'],
      fundDesc: ['锐意优选养老4号', '稳进优选养老4号', '安享优选养老4号'],
      urls: ['htffundxjb://action?type=oap&subType=pp&groupId=A0034', 'htffundxjb://action?type=oap&subType=pp&groupId=A0048', 'htffundxjb://action?type=oap&subType=pp&groupId=A0046']
    },
    combination5: {
      fundName: ['锐意优选养老5号', '稳进优选养老5号', '安享优选养老5号'],
      fundDesc: ['锐意优选养老5号', '稳进优选养老5号', '安享优选养老5号'],
      urls: ['htffundxjb://action?type=oap&subType=pp&groupId=A0028', 'htffundxjb://action?type=oap&subType=pp&groupId=A0044', 'htffundxjb://action?type=oap&subType=pp&groupId=A0041']
    } // fof: {
  ...
  }), _defineProperty(_data, "ageWithFundCombination1", {
    combination1: {
      fundName: ['锐意优选养老1号', '稳进优选养老1号', '安享优选养老1号'],
      fundDesc: ['锐意优选养老1号', '稳进优选养老1号', '安享优选养老1号'],
      urls: ['htffundxjb://action?type=oap&subType=mip&groupId=A0039', 'htffundxjb://action?type=oap&subType=mip&groupId=A0027', 'htffundxjb://action?type=oap&subType=mip&groupId=A0049']
    },
    // combination1: {
    //     fundName: ['锐意优选养老1号', '稳进优选养老1号', '安享优选养老1号'],
    //     fundDesc: ['锐意优选养老1号', '稳进优选养老1号', '安享优选养老1号'],
    ...
    combination2: {
      fundName: ['锐意优选养老2号', '稳进优选养老2号', '安享优选养老2号'],
      fundDesc: ['锐意优选养老2号', '稳进优选养老2号', '安享优选养老2号'],
      urls: ['htffundxjb://action?type=oap&subType=mip&groupId=A0042', 'htffundxjb://action?type=oap&subType=mip&groupId=A0043', 'htffundxjb://action?type=oap&subType=mip&groupId=A0035']
    },
    combination3: {
      fundName: ['锐意优选养老3号', '稳进优选养老3号', '安享优选养老3号'],
      fundDesc: ['锐意优选养老3号', '稳进优选养老3号', '安享优选养老3号'],
      urls: ['htffundxjb://action?type=oap&subType=mip&groupId=A0045', 'htffundxjb://action?type=oap&subType=mip&groupId=A0047', 'htffundxjb://action?type=oap&subType=mip&groupId=A0036']
    },
    combination4: {
      fundName: ['锐意优选养老4号', '稳进优选养老4号', '安享优选养老4号'],
      fundDesc: ['锐意优选养老4号', '稳进优选养老4号', '安享优选养老4号'],
      urls: ['htffundxjb://action?type=oap&subType=mip&groupId=A0034', 'htffundxjb://action?type=oap&subType=mip&groupId=A0048', 'htffundxjb://action?type=oap&subType=mip&groupId=A0046']
    },
    combination5: {
      fundName: ['锐意优选养老5号', '稳进优选养老5号', '安享优选养老5号'],
      fundDesc: ['锐意优选养老5号', '稳进优选养老5号', '安享优选养老5号'],
      urls: ['htffundxjb://action?type=oap&subType=mip&groupId=A0028', 'htffundxjb://action?type=oap&subType=mip&groupId=A0044', 'htffundxjb://action?type=oap&subType=mip&groupId=A0041']
    } // fof: {
    //     fundName: ['添富养老2030三年持有FOF', '添富养老2030三年持有FOF', '添富养老2030三年持有FOF'],
    //     fundDesc: ['添富养老2030三年持有FOF', '添富养老2030三年持有FOF', '添富养老2030三年持有FOF'],
  ...
  }), _defineProperty(_data, "currentFundIndex", 1), _defineProperty(_data, "isFofFund", false), _defineProperty(_data, "perCapitaIncomeIncreaseRate", 0.03), _defineProperty(_data, "pensionRate", 0.08), _defineProperty(_data, "pensionInterest", 0.02), _defineProperty(_data, "life", 85), _defineProperty(_data, "priceCoefficient", 0.035), _defineProperty(_data, "pensionIncomeRate", 0.1), _defineProperty(_data, "echars1", {}), _defineProperty(_data, "echars2", {}), _defineProperty(_data, "echars3", {}), _defineProperty(_data, "needAddCount1", {}), _defineProperty(_data, "needAddCount2", {}), _defineProperty(_data, "type", 1), _defineProperty(_data, "currentPage", 1), _defineProperty(_data, "firstEnterPageOne", true), _defineProperty(_data, "firstEnterPageTwo", true), _data),
  computed: {
    //控制前进后退 显示隐藏
    leftShow: function leftShow() {
    ...
    paidPensionYears: function paidPensionYears() {
      var paidPensionYears = [];

      for (var i = 0, len; i < 47; i++) {
        paidPensionYears.push({
          value: i,
          text: i + "年"
        });
      }
    ...
    //计划退休年龄
    retirementAge: function retirementAge() {
      var retirementAge = [];
    ...
    // 未来所存养老金总额
    futurePensionTotal: function futurePensionTotal() {
    ...
    // 最终养老金总额
    finalPensionCount: function finalPensionCount() {
      return this.Fix(this.hasSavedPensionTotal + this.futurePensionTotal, 4);
    },
    // 每月基础账户养老金
    baseCountPensionForMonth: function baseCountPensionForMonth() {
  ...
  mounted: function mounted() {
    ...
    ;
    this.getTeamId().then(function (result) {
      // console.log(result);
      _this2.teamId = result.teamId;
      return _this2.getTeamList(result.teamId);
    }).then(function (result2) {
      // console.log(result2);
      _this2.teamList = result2;

      if (Array.isArray(result2) && result2) {
        _this2.custNo = result2[0].custNo;
      } else {
        _this2.showBomb('家庭账户列表无数据', 'center'); // alert('家庭账户列表无数据');

      }
    }).catch(function (error) {
      // console.log(error);
      _this2.showBomb('家庭账户获取失败', 'center'); // alert('家庭账户获取失败')
  ...
  methods: {
    ...
    createPlan: function createPlan(url, type) {
      var params = {};
      var memberRoleName = '';
      var brithday = '';
	  var d = new Date();
      ...
      if (type == '0') {
        params.planAmount = this.needAddCount1.total < 1 ? '1' : this.Fix(this.needAddCount1.total, 0);
      } else {
        params.planAmount = this.needAddCount2.total < 1 ? '1' : this.Fix(this.needAddCount2.total, 0);
      }

      params.teamId = this.teamId;
	  d.setFullYear(d.getFullYear() + this.beforeRetireAge + 1);
	  params.estimateDate  = d.getFullYear() + '' + (d.getMonth() < 9 ? '0' + (d.getMonth() + 1) : d.getMonth() + 1) + (d.getDate() < 9 ? '0' + (d.getDate() ) : d.getDate());
      params.planName = memberRoleName + '的养老计划'; // console.log(params,'params');
      ...
      $.ajax({
        ...
        success: function (res) {
          if (res.returnCode == '0') {
            ...
            var realUrl = url + '&teamId=' + reslut.teamId + '&arAcct=' + reslut.arAcct + '&arAcctName=' + arAcctName+'&brithday='+brithday; // console.log(realUrl,'realUrl');

            window.location.href = realUrl;
          } else {
            this.showBomb(res.returnMsg, 'center'); // alert("创建失败");
          } // console.log(url);
        ...
        error: function error(_error3) {
          // console.log(error);
          this.showBomb('计划创建失败', 'center'); // alert("创建失败");
        }
      });
    },
    directCreatePlan: function directCreatePlan() {
      if (this.teamId) {
        window.location.href = 'htffundxjb://action?type=familyAccount&subType=createPensionPlan&teamId=' + this.teamId;
      } else {
        this.showBomb('家庭账户获取失败'); // alert('获取账户失败');
      }
    },
    ...
    nextPage: function nextPage() {
      ...
      $(".homePage").animate({
        ...
        $(".homePage").hide();
        $(".homePage2").show();
        document.body.scrollTop = document.documentElement.scrollTop = 0; //转盘指针
    ...
    setEcharsOption: function setEcharsOption(data, xArr, type) {
      var _this = this;
      ...
      var option = {
        ...
        tooltip: {
          ...
          formatter: '<div style="display: -webkit-box;display: -ms-flexbox;display: -webkit-flex;display: flex;-webkit-box-pack: justify;-ms-flex-pack: justify;-webkit-justify-content: space-between;justify-content: space-between;" padding: 0 .5rem;>' + '<h3 style="line-height: 1.5; padding-top: 0;width: 7.75rem; "><span  style="color:rgb(51, 51, 51);  padding-top:0;">组合模拟收益</span> <span class="tips" onclick="showBomb()" style="color:#178ce6; text-align: center; padding: 0;pointer-events: all;"></span></h3>' + '<div style="line-height: 1.5;text-align: center;width: 7.75rem;">' + '<span style="display:inline-block;margin-right:5px;width:9px;height:9px;background-color:#ff7215"></span>{a3} : <span style="color:#f4333c">{c3}</span>' + '</div >' + '</div>' + '<div class="row">' + '<div style="display: -webkit-box;display: -ms-flexbox;display: -webkit-flex;display: flex;-webkit-box-pack: justify;-ms-flex-pack: justify;-webkit-justify-content: space-between;justify-content: space-between; ">' + '<div class="col-1" style="display: -webkit-box;display: -ms-flexbox;display: -webkit-flex;display: flex;-webkit-box-orient: vertical;-ms-flex-direction: column;-webkit-flex-direction: column;flex-direction:column;-webkit-align-items:center;box-align:center;-moz-box-align:center;-webkit-box-align:center;align-items: center; ">' + '<div><span style="display:inline-block;margin-right:5px;width:9px;height:9px;background-color:#ffe6c4"></span>{a0}</div><div style="color:#f4333c">{c0}</div>' + '</div>' + '<div class="col-1" style="display: -webkit-box;display: -ms-flexbox;display: -webkit-flex;display: flex;-webkit-box-orient: vertical;-ms-flex-direction: column;-webkit-flex-direction: column;flex-direction:column;-webkit-align-items:center;box-align:center;-moz-box-align:center;-webkit-box-align:center;align-items: center; " >' + '<div><span style="display:inline-block;margin-right:5px;width:9px;height:9px;background-color:#ffc56d"></span>{a1}</div>  <div style="color:#f4333c">{c1}</div>' + '</div>' + '<div class="col-1" style="display: -webkit-box;display: -ms-flexbox;display: -webkit-flex;display: flex;-webkit-box-orient: vertical;-ms-flex-direction: column;-webkit-flex-direction: column;flex-direction:column;-webkit-align-items:center;box-align:center;-moz-box-align:center;-webkit-box-align:center;align-items: center;">' + '<div><span style="display:inline-block;margin-right:5px;width:9px;height:9px;background-color:#ff9f51"></span>{a2}</div>  <div style="color:#f4333c">{c2}</div>' + '</div>' + '</div>' + '</div>'
        },
        grid: {
          left: '10%',
          right: '10%',
      ...
      for (var i = 0; i < maxValueArr.length; i++) {
        ...
        $.extend(true, option.series[1].markPoint.data[1], {
          yAxis: targetValueForY
        });
        $.extend(true, option.series[1].markPoint.data[1], {
          value: targetValue
        });
        $.extend(true, option.series[1].markLine.data[1][0], {
          yAxis: targetValueForY
        });
        $.extend(true, option.series[1].markLine.data[1][0], {
          value: targetValue
        });
        $.extend(true, option.series[1].markLine.data[1][1], {
          yAxis: targetValueForY
        });
        $.extend(true, option.series[1].markLine.data[1][1], {
          value: targetValue
    ...
    setOptionData: function setOptionData(option, fundData, targetValue, index) {
      ...
      if (averageVal > targetValue) {
        option.series[1].markPoint.data[0].label = {
          normal: {
            position: [0, -20]
          }
        };
        option.series[1].markPoint.data[1].label = {
          normal: {
            position: [0, 5]
          }
        };
    ...
    drawEcharts: function drawEcharts(type) {
      //图绘制
      var _this = this;
      ...
      s.src = 'qinqing/y_' + (birthday + 1) + (type == 1 ? 'D.js' : '.js');
      ...
      s.onload = function () {
        ...
        $(".homePage2").animate({
          ...
          $(".figureTip").css({
            left: _this.left - $(".figureTip").width() / 2
          });
          _this.toLeft = _this.left;
          _this.maxLeft = $(".bigslide").width(); //百分比

          _this.leftPercent = $(".ruling").width() * 0.4;
          $(".pointer").css({
            left: _this.leftPercent - $(".pointer").width() / 2
          });
    ...
    nextPageMonth: function nextPageMonth(type) {
      this.type = type; // 设置默认值
    ...
    nextPageSingle: function nextPageSingle(type) {
      this.type = type; // 设置默认值
    ...
    //显示弹窗
    showBomb: function showBomb(text, position) {
    ...
    percentEnd: function percentEnd(e) {
      var date = new Date();
      var xArr = [];
      var beforeRetireAge = 0;
      var m = 0;
    ...
    Fix: function Fix(num, digit) {
      return Number(Number(num).toFixed(digit));
    },
    // 用于计算已经存下的养老金数(参数:当前收入,当地平均收入,已工作年限,养老金率,工资年增长率)
    calcHasSavedPension: function calcHasSavedPension(currentIncome, averageIncomeInProvince, hasWorkedYear, pensionRate, incomeYearIncreaseRate) {
      var firstIncome = this.Fix(currentIncome / Math.pow(1 + incomeYearIncreaseRate, hasWorkedYear), 4); // 首次缴纳养老金时月工资

      var endIncome = currentIncome; // var firstIncomeForPension = Math.max(averageIncomeInProvince * 0.6, Math.min(firstIncome, averageIncomeInProvince * 3));
    ...
    calcForFuturePension: function calcForFuturePension(averageIncomeInProvince, beforeRetireAge, perCapitaIncomeIncreaseRate, currentIncome, pensionRate, incomeYearIncreaseRate) {
    ...
    calcBaseCountPensionForMonth: function calcBaseCountPensionForMonth(incomeYearIncreaseRate, perCapitaIncomeIncreaseRate, currentIncome, averageIncomeInProvince, beforeRetireAge, allPensionAge) {
    ...
    calcPensionGapTotal: function calcPensionGapTotal(pensionGapForYear, pensionInterest, periods) {
    ...
    calcNeedAddCountForExpect: function calcNeedAddCountForExpect(WishPensionForMonth, pensionForMonthAtNow, priceCoefficient, beforeRetireAge, pensionInterest, annualYield, leftAge, type) {
      var pensionGapForMonth = (WishPensionForMonth - pensionForMonthAtNow) * Math.pow(1 + priceCoefficient, beforeRetireAge); // 每月养老金缺口

      var pensionGapTotal = pensionGapForMonth * (1 - 1 / Math.pow(1 + pensionInterest / 12, leftAge * 12)) / (1 - 1 / (1 + pensionInterest / 12)) / (1 + pensionInterest / 12); // console.log("-------------这里是数据检测-------------");
      ...
      if (type == 0) {
        return {
          count: pensionGapTotal / Math.pow(1 + annualYield, beforeRetireAge),
          // (直投法)现在所需资金
      ...
      if (type == 1) {
        return {
          count: pensionGapTotal * annualYield / 12 / (Math.pow(1 + annualYield / 12, beforeRetireAge * 12 + 1) - (1 + annualYield / 12)),
          // (定投法)按每月积累
          total: pensionGapTotal // 总资产
  ...
  memberId: function(newValue, oldValue){
    ...
    annualYield: function annualYield(newValue, oldValue) {
    ...
    WishPensionForMonth: function WishPensionForMonth(newValue, oldValue) {
      this.needAddCount2 = this.calcNeedAddCountForExpect(this.WishPensionForMonth, this.pensionForMonthAtNow, this.priceCoefficient, this.beforeRetireAge, this.pensionInterest, this.annualYield, this.leftPensionAge, this.type);
      this.needAddCount1 = this.calcNeedAddCountForExpect(this.WishPensionForMonth, this.pensionForMonthAtNow, this.priceCoefficient, this.beforeRetireAge, this.pensionInterest, this.annualYield, this.leftPensionAge, this.type);
    }
  }
