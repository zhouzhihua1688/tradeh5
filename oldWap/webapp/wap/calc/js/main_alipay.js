...
var vm = new Vue({
    ...
    data: {
        ...
        ageWithFundCombination0: {
            combination1: {
                fundName: ['蓝筹稳健', '价值精选', '高息债C'],
                fundDesc: ['蓝筹稳健', '价值精选', '高息债C'],
                urls: ['alipays://platformapi/startapp?appId=20000793&pullRefresh=NO&appClearTop=false&startMultApp=YES&url=%2Fwww%2Fdetail.html%3FproductId%3D20150718000230030000000000000327',
                    'alipays://platformapi/startapp?appId=20000793&pullRefresh=NO&appClearTop=false&startMultApp=YES&url=%2Fwww%2Fdetail.html%3FproductId%3D20150718000230030000000000000231',
                    'alipays://platformapi/startapp?appId=20000793&pullRefresh=NO&appClearTop=false&startMultApp=YES&url=%2Fwww%2Fdetail.html%3FproductId%3D20150718000230030000000000002280']
            },
            //测试链接
            // combination1: {
            //     fundName: ['锐意优选养老1号', '稳进优选养老1号', '安享优选养老1号'],
            //     fundDesc: ['锐意优选养老1号', '稳进优选养老1号', '安享优选养老1号'],
            //     urls: ['htffundxjb://action?type=fg&subType=fgp&groupId=A0421',
            //         'htffundxjb://action?type=fg&subType=fgp&groupId=A0296',
            //         'htffundxjb://action?type=fg&subType=fgp&groupId=A0302']
            // },
            combination2: {
                fundName: ['蓝筹稳健', '价值精选', '高息债C'],
                fundDesc: ['蓝筹稳健', '价值精选', '高息债C'],
            ...
            fof: {
                ...
                urls: ['alipays://platformapi/startapp?appId=20000793&pullRefresh=NO&appClearTop=false&startMultApp=YES&url=%2Fwww%2Fdetail.html%3FproductId%3D20181205000230030000000000015659',
                    'alipays://platformapi/startapp?appId=20000793&pullRefresh=NO&appClearTop=false&startMultApp=YES&url=%2Fwww%2Fdetail.html%3FproductId%3D20181205000230030000000000015659',
                    'alipays://platformapi/startapp?appId=20000793&pullRefresh=NO&appClearTop=false&startMultApp=YES&url=%2Fwww%2Fdetail.html%3FproductId%3D20181205000230030000000000015659']
            }
        },
    ...
    methods: {
        ...
        jumpPage: function () {
            var _this = this;
            my.postMessage({
                jumpUrl: _this.fundCombinationInfo.urls[_this.currentFundIndex]
            });
        },
        //重写
        rewrite: function () {
        ...
        buttonLeft: function () {
            if (this.currentFundIndex == 0) {
                return;
            }
            this.currentFundIndex--;
            if (this.currentFundIndex == 0) {
