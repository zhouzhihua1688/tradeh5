...
window.utils = {
    ...
    _tipsTemplate: function (params) {
        ...
        var template = $(`
            <div id='_showTips_' style="position: fixed;top: 0;left: 0;right: 0;bottom: 0;z-index: 1000;background: rgba(0, 0, 0, 0.7);display: flex;justify-content: center;align-items: center;font-size:calc(100vw/20);" >
                <div style="width: 15em;background-color: #fff;border-radius: 0.3em;">
                    <header style="text-align: center;color: #333;font-size: 0.8em;padding: .5em 0;">${params.title?params.title:''}</header>
                    <p class="_showTips_content" style="text-align: center;color: #666;font-size: 0.65em;padding: 0 1.5em 0.75em;padding-bottom:1em">${params.content?params.content:''}</p>
        ...
        params.showCancel && template.find('._showTips_confirm').after('<button class="_showTips_cancel"  style="color:#0070fa;width: 100%;padding: .3em 0;font-size: 0.75em;border: none;background-color: transparent;outline: none;border-radius: 0;line-height: inherit;border-left: solid 1px #eeeeee;">取消</button>')
