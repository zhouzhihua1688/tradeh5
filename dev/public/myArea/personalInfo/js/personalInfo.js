...
$(".li-address").click(function () {
    window.location.href = "/mobileEC/wap/userInfo/contactAddress.html?page=personalInfo";
});
$(".li-actual-Controller").click(function () {
    window.location.href = "/mobileEC/wap/userInfo/actualAccountController.html?page=personalInfo";
});
$(".li-actual-beneficiary").click(function () {
    window.location.href = "/mobileEC/wap/userInfo/actualAccountBeneficiary.html?page=personalInfo";
});
$(".li-due-diligence").click(function () {
    window.location.href = "/mobileEC/wap/userInfo/dueDiligence.html?page=personalInfo";
});
$(".li-integrity-problem").click(function () {
    window.location.href = "/mobileEC/wap/userInfo/isExistsIntegrityProblem.html?page=personalInfo";
});
                        ...
                        $(".upload-idno-pic").click(function (){
                            if(navigator.userAgent.indexOf('htfxjb') > -1){
                                ...
                                if(idTp == '0'){
                                    ...
                                    window.location.href = "/mobileEC/wap/userInfo/noIdCardUpdate.html?idTp="+idTp+'&page=personalInfo' + location.search;   //非身份证
                                }
                            }
                        });
                    }
                                ...
                                complete: function () {
                                    if(navigator.userAgent.indexOf('htfxjb') > -1){
                                        ...
                                        if(idTp == '0'){
                                            ...
                                            window.location.href = "/mobileEC/wap/userInfo/noIdCardUpdate.html?page=personalInfo" + location.search;   //非身份证
                                        }
                                    }
                                },
                                showCancel: true,
        ...
        App.put(url, JSON.stringify(saveData), function (result3) {
            ...
            if(navigator.userAgent.indexOf('htfxjb') > -1){
                ...
                if(bindCardToCompleteInfo == 1){ // 只设置交易密码，未完善信息，跳转至交易密码设置成功页面
                    if(referUrl){
                        window.location.href = '/mobileEC/wap/card/setTradePwdSuccess.html?referUrl=' + encodeURIComponent(referUrl);
                    }
                    else if(forwardUrl){
                        window.location.href = '/mobileEC/wap/card/setTradePwdSuccess.html?forwardUrl=' + encodeURIComponent(forwardUrl);
                    }
                    else {
                    ...
                    if(referUrl){
                        window.location.href = '/mobileEC/wap/card/bindCardSuccess.html?referUrl=' + encodeURIComponent(referUrl);
                    }
                    else if(forwardUrl){
                        window.location.href = '/mobileEC/wap/card/bindCardSuccess.html?forwardUrl=' + encodeURIComponent(forwardUrl);
                    }
                    else {
                    ...
                    if(!forwardUrl && !referUrl){ // forwardUrl和referUrl都不存在，跳转至首页
                        ...
                        window.location.href = referUrl ? referUrl : '/mobileEC/wap/wezhan/service.html';
                    }
                }
            }
        });
