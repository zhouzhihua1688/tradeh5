...
function queryFee(li) {
    ...
    if (App.isNotEmpty(purAmt)) {
        ...
        bankNo = (bankNo == undefined || bankNo == 'null') ? '' : bankNo;
        var url = "/mobile-bff/v1/fund/fund-fee?subAmt="+ purAmt + "&fundId="+ fundId + "&cashFrm=" + cashFrom +"&bankNo=" + bankNo +"&shareType=A"
...
function showSmTip() {
    ...
    var url = "/mobile-bff/v1/common/check-union-risk-level?productId=" + productId;
