...
var ch_type = "ch" + fundtp;
var chfundLists = App.getSession(ch_type + App.fundLists);

function init() {
    if (chfundLists == null || chfundLists.length == 0) {
        queryFundList();
        chfundLists = App.getSession(ch_type + App.fundLists)
    };
    showFundList(chfundLists, fundtp)
};
init();
$(function() {
...
function queryFundList() {
    ...
    App.get(url, null, function(result) {
        App.setSession(ch_type + App.fundLists, result.body.fund);
