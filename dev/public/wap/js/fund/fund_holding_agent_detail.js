...
function renderingPage() {
    ...
    if(item != undefined && item != null) {
        ...
        setVal("#yield", item.fund.yield == 0 ? "0.00" : App.formatMoney(item.fund.yield, 2), "%");

        $("#union_balance").html(item.unionBalance == 0 ? "0.00" : App.formatMoney(item.unionBalance));
