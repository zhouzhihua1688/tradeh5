                ...
                switch(result.returnCode){
                    ...
                    case 4103:
                        ...
                        if(nonTrade == '1')
                            ...
                            } else if(HTF.getCookie('channelCode') === 'zhengtong'){
...
function sessionExpireLogin() {
	if(App.getCookie("channelCode") === 'airstar' || App.getCookie("channelCode") === 'zhengtong'){//小米金融或者证通渠道
...
// 20220720添加证通渠道，同小米金融
// S 20210301 小米金融，去掉页面底部引导条 下载现金宝APP
if((App.getCookie("channelCode")==='airstar' || App.getCookie("channelCode")==='zhengtong') && $('.bottom .logo').siblings('a').attr('href') === 'https://www.99fund.com/m.htm'){
