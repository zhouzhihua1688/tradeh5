...
var forwardUrl = window.location.origin + '/mobileEC/wap/wezhan/service.html';
$(".xjj_take_back").hide();
$(function () {
   ...
   // $(".xjj_take_back").attr("href", "../fundgroup/redeem.html?groupId=A0081&groupType=08");  // 20220307添加备注，foudgroup/redeem.html跳转url必须有balanceSerialNo
    ...
    App.get(url, null, function(result){
        if (result.body != undefined && result.body != null){
            ...
            if(list1.length == 0){
                ...
                //20210712 跳转到新增面
                $(".func_list_1").append(getHtml('工资宝', '../account/autoTopUpList.html','一次设置，工资定期转入，轻松赚取收益', list1));
            }
            // $(".func_list_1").append(getHtml('工资宝', '../account/autoTopUpCM.html?handTp=C','一次设置，工资定期转入，轻松赚取收益', list1));
            // $(".func_list_1").append(getHtml('工资宝', '../account/autoTopUpList.html','一次设置，工资定期转入，轻松赚取收益', list1));
            //还款专区
            ...
            if(body != undefined && body != null){
                ...
                if(body.cashPlusAsset != undefined && body.cashPlusAsset != null){
                    ...
                    if(cashPlusAsset.totalAmt > 0){
                        ...
                        $(".xjj_take_back").attr("href", "../fundgroup/redeem.html?groupId=A0081&groupType=08&balanceSerialNo="+serialNo+"&forwardUrl="+forwardUrl);
