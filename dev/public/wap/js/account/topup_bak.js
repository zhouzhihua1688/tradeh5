...
function confirmRecharge(){
    ...
    if(card != null || card != undefined){
        ...
        var data = JSON.stringify({"bankAcco":card.bankAcco,"bankNo":card.bankNo, "bankSerialId":card.bankCardSerialid, "subAmt":subAmt,"baseAccountCode":selectedFundId,"acceptMode":acceptMode});
//        console.log(data);
        App.post(url, data, function(){
            ...
            App.setSession("risk_fundId",selectedFundId);
...
function queryRechargeDate(){
    ...
    var url = '/mobile-bff/v1/etrading/get-ec-recharge?date='+ (new Date()).getTime();
...
function queryCard(successFun) {
    ...
    var url = "/mobile-bff/v1/pay/pay-bank-list?currencyType=156&tradeType=00&tradeScene=13" ;
	App.get(url, null, function (result) {
