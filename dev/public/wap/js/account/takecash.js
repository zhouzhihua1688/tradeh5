...
function initCardList() {
    ...
    for (var index in cards) {
        ...
        $("#cards_panel").append("<div class='card-list1' data='" + index + "," + card.bankNo + "," + card.bankAcco + "," + card.realLimit + "," + card.bankName + "," + card.bankAccoDisplay + "," + card.limit + "," + card.cashBalance+ "," + card.bankCardSerialid + "'>" + "<div class='left1'>" + "<div class='f16 f-black'>" + card.bankName + "</div>" + "<div class='f11' style='margin-top: 4px'>储蓄卡&nbsp;&nbsp;" + card.bankAccoDisplay + "</div>" + "</div>" + "<div class='right1'><input type='radio' name='card'" + (bool ? "checked='checked'" : "") + "></div>" + "</div>")
    };
