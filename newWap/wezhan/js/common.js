...
var HTF = {
    ...
    getCodeBase: function () {
        if(document.domain.indexOf("mdev") > -1 || document.domain.indexOf("99fund.com.cn") > -1 || 
        document.domain.indexOf("wxappdev.99fund.com") > -1) {//测试
...
$(function(){
    ...
    if(window.location.pathname.indexOf('wapWeb') == -1){
        $(document.body).append("<div id='over' class='over'></div>"
            +"<div id='layout' class='layout' style='display:none'><div class='loading-img'><img src='"+ loadingImagePath +"/img/hook/loadingHUD.png' /></div><div class='f12 f-white'>加载中..</div></div>");
    }
    if(App.isWeixin()){
		/*
        $(".top-bar").hide();
...
$(".goto_login").click(function () {
    window.location.href = "../login/login.html?referUrl=" + encodeURIComponent(document.URL);
});
